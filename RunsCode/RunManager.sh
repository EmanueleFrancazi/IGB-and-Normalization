...
for ((i=$1; i<=$2; i++))
do
	python3 ./RunsCode/ViT/train.py --name cifar10-100_500 --dataset CatsVsDogs --model_type ViT-B_16 --pretrained_dir ./checkpoint/ViT-B_16.npz --SampleIndex $i --train_batch_size 256 --gradient_accumulation_steps 2
done
